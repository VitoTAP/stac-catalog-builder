...
def build_collection(
    ...
    """Build a STAC collection for the pre-composited Agera5 collection on CDSE."""
    ...
    file_coll_cfg = FileCollectorConfig(input_dir=Path("/home/vincent.verelst/Public/create_agera5_monthly/results"), glob="*.tif", max_files=200000)
...
build_collection("agera5_monthly","./STAC")