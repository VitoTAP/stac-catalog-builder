...
def build_collection(
    ...
    """Build a STAC collection for the pre-composited Agera5 collection on Terrascope."""
    ...
    file_coll_cfg = FileCollectorConfig(input_dir=Path("/data/worldcereal_data/agera5_monthly"), glob="*.tif", max_files=200000)
...
build_collection("agera5_monthly_terrascope","./STAC")