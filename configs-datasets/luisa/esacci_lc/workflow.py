...
def build_collection(
    ...
    """Build a STAC collection for the ESA CCI Landocover dataset"""
    ...
    file_coll_cfg = FileCollectorConfig(input_dir=Path("/data/open/luisa/esacci_lc"), glob="*.tif", max_files=200000)
...
build_collection("ESACCI_LANDCOVER","./STAC")
