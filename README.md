...
- [STAC Catalog Builder](#stac-catalog-builder)
  ...
  - [Running the Stacbuilder Tool](#running-the-stacbuilder-tool)
    ...
    - [Building a Collection](#building-a-collection)
      - [1. `config-collection.json`](#1-config-collectionjson)
      - [2. `Makefile`](#2-makefile)
    - [The main variables to change in the Makefile](#the-main-variables-to-change-in-the-makefile)
  - [Stacbuilder commands and options](#stacbuilder-commands-and-options)
    - [a) Run the __main__.py file](#a-run-the-mainpy-file)
    - [a) Run it as a module](#a-run-it-as-a-module)
    - [Usage](#usage)
